...
function SettingsPage() {
  return <div className="mx-auto max-w-[700px]"><PageHeading eyebrow="Settings" title="Workspace" body="Account and studio preferences." /><Notice>Studio is live. AI images use Replicate when REPLICATE_API_TOKEN is set.</Notice></div>;
}
